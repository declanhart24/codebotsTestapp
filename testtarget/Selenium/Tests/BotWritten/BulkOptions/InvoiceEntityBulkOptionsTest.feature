...
Feature: InvoiceEntity Bulk Option Selection
# WARNING: These Tests have been flagged as needing web fixes and are currently ignored

@InvoiceEntity
Scenario: Select all InvoiceEntitys on current page
...
@InvoiceEntity
Scenario: I attempt to select all InvoiceEntitys on all pages
Given I login to the site as a user
And I navigate to the InvoiceEntity backend page
When I select all entities on current page
