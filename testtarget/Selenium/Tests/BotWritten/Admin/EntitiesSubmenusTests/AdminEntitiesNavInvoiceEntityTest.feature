...
Feature: Admin Submenu InvoiceEntity
	
	@InvoiceEntity
	Scenario: Admin Submenu InvoiceEntity
	...
	And I click the invoice admin submenu
	Then I assert that I am on the invoice Entity backend page