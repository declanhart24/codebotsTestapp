...
@InvoiceEntity
Scenario: Select all InvoiceEntity entities on current page
Given I login to the site as a user
And I navigate to the InvoiceEntity backend page
And I have 30 valid InvoiceEntity entities
...
@InvoiceEntity
Scenario: Verify InvoiceEntity entity selection is persistant across pages
Given I login to the site as a user
And I navigate to the InvoiceEntity backend page
And I have 30 valid InvoiceEntity entities
When I select all entities on current page
...
@InvoiceEntity
Scenario: Verify InvoiceEntity entity checkboxes are persistant across pages
Given I login to the site as a user
And I navigate to the InvoiceEntity backend page
And I have 30 valid InvoiceEntity entities
When I select all entities on all pages
...
@InvoiceEntity
Scenario: InvoiceEntity checkbox single page deselect persistance test
Given I login to the site as a user
And I navigate to the InvoiceEntity backend page
And I have 30 valid InvoiceEntity entities
When I select all entities on current page
