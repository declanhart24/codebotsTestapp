...
Feature: InvoiceEntity Pagination Feature
# WARNING: These Tests have been flagged as needing web fixes and are currently ignored

@InvoiceEntity
Scenario: Exceed upper pagination limit on InvoiceEntity
...
@InvoiceEntity
Scenario: Exceed lower pagination limit on InvoiceEntity
Given I login to the site as a user
And I navigate to the InvoiceEntity backend page
...
@InvoiceEntity
Scenario: InvoiceEntity next page
Given I login to the site as a user
And I navigate to the InvoiceEntity backend page
When I click on the next page button and validate page content
When I click on the next page button and validate page content
...
@InvoiceEntity
Scenario: InvoiceEntity previous page
Given I login to the site as a user
And I navigate to the InvoiceEntity backend page
When I click on the last page button and validate page content
When I click on the previous page button and validate page content
