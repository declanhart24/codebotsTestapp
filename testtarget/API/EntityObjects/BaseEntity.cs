...
using TestDBContext = Test.Models.TestDBContext;
using RestSharp;
...
namespace APITests.EntityObjects.Models
{
	...
	public abstract class BaseEntity
	{
		...
		internal Guid SaveToDB<T>(T model) where T : class, Test.Models.IOwnerAbstractModel
		{
			var configure = new StartupTestFixture();
			// % protected region % [Adjust the db context if required] off begin
			var context = new TestDBContext(configure.DbContextOptions, null, null);
