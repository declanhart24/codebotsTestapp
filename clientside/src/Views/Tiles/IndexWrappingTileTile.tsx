...
@observer
export default class IndexWrappingTileTile extends React.Component<RouteComponentProps> {
	...
	public render() {
		let contents = (
			<>
				<EntityCRUD {...this.props} modelType={Models.InvoiceEntity} URLExtension={'InvoiceDetails'}/>
			</>
		);
