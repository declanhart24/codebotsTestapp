...
namespace Test.Models {
	public class User : IdentityUser<Guid>, IOwnerAbstractModel
	{
		...
		public virtual void BeforeSave(EntityState operation, TestDBContext dbContext, IServiceProvider serviceProvider)
		{
			// % protected region % [Add any before save logic here] off begin
			// % protected region % [Add any before save logic here] end
		}

		public virtual void AfterSave(EntityState operation, TestDBContext dbContext, IServiceProvider serviceProvider)
		{
		...
		public virtual int CleanReference<T>(string reference, IEnumerable<T> models, TestDBContext dbContext) where T : IOwnerAbstractModel
		{
			return 0;
		}
