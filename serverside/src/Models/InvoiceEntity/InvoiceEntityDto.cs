...
namespace Test.Models
{
	...
	/// Invoice Table
	/// </summary>
	public class InvoiceEntityDto : ModelDto<InvoiceEntity>
	{
		...
		public override InvoiceEntity ToModel()
		{
		...
		public override ModelDto<InvoiceEntity> LoadModelData(InvoiceEntity model)
		{
			Id = model.Id;
