...
namespace Test.Models {
	...
	public interface IAbstractModel
	{
		...
		void BeforeSave(EntityState operation, TestDBContext dbContext, IServiceProvider serviceProvider);
		void AfterSave(EntityState operation, TestDBContext dbContext, IServiceProvider serviceProvider);
