...
using Test.Graphql.Fields;
using Test.Graphql.Helpers;
...
namespace Test.Graphql
{
	...
	public class TestQuery : QueryGraphType<TestDBContext>
	{
		...
		public TestQuery(IEfGraphQLService<TestDBContext> efGraphQlService) : base(efGraphQlService)
		{
			// Add query types for each entity
			AddModelQueryField<InvoiceEntityType, InvoiceEntity>("InvoiceEntity");
	...
	public class TestMutation : ObjectGraphType<object>
	{
		...
		public TestMutation()
		{
			...
			AddMutationField<InvoiceEntityInputType, InvoiceEntityInputType, InvoiceEntityType, InvoiceEntity>("InvoiceEntity");
