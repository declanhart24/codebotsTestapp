...
namespace Test.Utility
{
	public static class UsersFilter
	{
		...
		public static Expression<Func<User, bool>> AllUsersFilter(User user, IList<string> groups, DATABASE_OPERATION operation)
		{
			...
			where TModel : class, IOwnerAbstractModel, new()
		{
			return ExpressionHelper.AndExpressions(
				new List<Expression<Func<User, bool>>>
				{
					SecurityService.GetAggregatedUserModelAcls<TModel>(user, groups, operation),
